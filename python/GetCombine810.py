...
if __name__ == '__main__':
    ...
    for massPoint in massIterable:
        ...
        if doSignificance and doHybridNew:
            ...
            if not glob.glob(getFileName("higgsCombine",massPoint,boxInput,model,lumi,directory,"Significance",0)): continue
            print "INFO: opening %s"%(getFileName("higgsCombine",massPoint,boxInput,model,lumi,directory,"Significance",0))
            tFile = rt.TFile.Open(getFileName("higgsCombine",massPoint,boxInput,model,lumi,directory,"Significance",0))
        elif bayes:
            ...
            if not glob.glob(getFileName("higgsCombine",massPoint,boxInput,model,lumi,directory,"AsymptoticLimits",0)): continue
            print "INFO: opening %s"%(getFileName("higgsCombine",massPoint,boxInput,model,lumi,directory,"AsymptoticLimits",0))
            tFile = rt.TFile.Open(getFileName("higgsCombine",massPoint,boxInput,model,lumi,directory,"AsymptoticLimits",0))
