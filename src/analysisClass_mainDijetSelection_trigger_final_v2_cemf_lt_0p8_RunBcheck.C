  ...
  :baseClass(inputList, cutFile, treeName, outputFileName, cutEfficFile)
{
  ...
  if( int(getPreCutValue1("useJECs"))==1 )
  {
    ...
    // Using IOV JEC now. Now that's 2016. See include/IOV.h  and IOV.C for changing versions.
   ...
   std::string L1DATAPath = "data/Fall17_17Nov2017_V6_DATA/RunB/Fall17_17Nov2017B_V6_DATA_L1FastJet_AK4PFchs.txt";
    std::string L2DATAPath = "data/Fall17_17Nov2017_V6_DATA/RunB/Fall17_17Nov2017B_V6_DATA_L2Relative_AK4PFchs.txt"; 
    std::string L3DATAPath = "data/Fall17_17Nov2017_V6_DATA/RunB/Fall17_17Nov2017B_V6_DATA_L3Absolute_AK4PFchs.txt";
    std::string L2L3ResidualPath = "data/Fall17_17Nov2017_V6_DATA/RunB/Fall17_17Nov2017B_V6_DATA_L2L3Residual_AK4PFchs.txt";
...
void analysisClass::Loop()
{
   ...
   char* HLTname[50]    = {"noTrig","PFHT1050","PFJet550","Mu50", "AK8PFJet500","CaloJet550","Mu50_AllJet","PFHT1050_not_OR_from_others","PFJet550_not_OR_from_others","AK8PFJet500_not_OR_from_others","CaloJet550_not_OR_from_others","PFHT1050_OR_AK8PFJet500","PFHT1050_OR_PFJet550","PFHT1050_OR_CaloJet550"};
...
if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second)&& triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass[4] -> Fill(MJJWide);
...
if(  ( triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second) &&! ( triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)
)) h_mjj_HLTpass[7] -> Fill(MJJWide);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second) &&! ( triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)
...
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second) &&! ( triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) 
