   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	 ...
	 f2 = p0 + p1 * log( wj2.Pt() ) + p2 * log( wj2.Pt() ) * log( wj2.Pt() ) ;
       */
       ...
       /*
       // HLT-Reco correction for Moriond17
       ...
       */
       ...
       /*
       // HLT-Reco correction after Moriond17 - IOV system also for CaloJets
       float p0 = -26.0058;
       float p1 = 7.32690;
       float p2 = -0.552001;
       ...
       */
       ...
       /*
       // new 2016 bias correction with IOV system for Res and HLT-Reco correction
       float p0;
       float p1;
       float p2;
       ...
       if( runNo >= 1 && runNo <= 276823 ){ // Run2016BCD
	 // std::cout<< "Run2016BCD" << std::endl;
	 p0 = -3.03601e+01;
	 p1 = 8.54708e+00;
	 p2 = -6.41985e-01;
       }
       else if( runNo >= 276824 && runNo <= 277815 ){ // Run2016E 
	 // std::cout<< "Run2016E" << std::endl;
	 p0 = -3.14290e+01;
	 p1 = 9.58863e+00;
	 p2 = -7.47892e-01;
       }
       else if( runNo >= 277816 && runNo <= 278801 ){ // Run2016F
	 // std::cout<< "Run2016F" << std::endl;
	 p0 = -3.21730e+01;
	 p1 = 1.01856e+01;
	 p2 = -8.26144e-01;
       }
       else if( runNo >= 278802 && runNo <= 999999 ){ // Run2016G
	 // std::cout<< "Run2016G" << std::endl;
	 p0 = -2.82339e+01;
	 p1 = 7.95804e+00;
	 p2 = -5.99060e-01;
       }else{
	 std::cout<< "runNo OUT OF RANGE" << std::endl;
       }
       ...
       */
       ...
       // new 2016 bias correction with IOV system for Res and HLT-Reco correction + eta-dependent

       // DEBUGGING
       // std::cout<< "BEFORE CORRECTION"<< std::endl;
       // std::cout<< "wj1"<< std::endl;
       // std::cout<< "Pt: "<< wj1.Pt()<< " Eta: "<<wj1.Eta() << " Phi: "<< wj1.Phi()<< std::endl;
       // std::cout<< "wj2"<< std::endl;
       // std::cout<< "Pt: "<< wj2.Pt()<< " Eta: "<<wj2.Eta() << " Phi: "<< wj2.Phi()<< std::endl;

       std::vector<double> f_HLTReco;
       // loop on widejets
	 ...
	 // std::cout<< "wj_i"<< std::endl;
	 // std::cout<< "Pt: "<< wj_i.Pt()<< " Eta: "<<wj_i.Eta() << " Phi: "<< wj_i.Phi()<< std::endl;
	 ...
	 if( runNo >= 1 && runNo <= 276823 ){ // Run2016BCD
	   // std::cout<< "Run2016BCD" << std::endl;
	   if( fabs(wj_i.Eta())<=1.3 ){
	     // std::cout<< "|eta| < 1.3" << std::endl;
	     p0 = -2.97322e+01;
	     p1 = 8.56657e+00;
	     p2 = -6.56580e-01;
	   }else if( fabs(wj_i.Eta())>1.3 && fabs(wj_i.Eta()) <=2.5 ){
	     // std::cout<< "1.3 < |eta| < 2.5" << std::endl;
	     p0 = -3.52634e+01;
	     p1 = 1.00689e+01;
	     p2 = -7.82283e-01;
	   }
	 ...
	 f_i = p0 + p1 * log( wj_i.Pt() ) + p2 * log( wj_i.Pt() ) * log( wj_i.Pt() ) ;

	 f_HLTReco.push_back( f_i );
       }

       // std::cout<< "f1: " << f_HLTReco[0] << std::endl;
       // std::cout<< "f2: " << f_HLTReco[1] << std::endl;
       ...
       //       corr1 = 1. / (1. + 0.01*f1);
       //       corr2 = 1. / (1. + 0.01*f2);
       corr1 = 1. / (1. + 0.01*f_HLTReco[0]);
       corr2 = 1. / (1. + 0.01*f_HLTReco[1]);
