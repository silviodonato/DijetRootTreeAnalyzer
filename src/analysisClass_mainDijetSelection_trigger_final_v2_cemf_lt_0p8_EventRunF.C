 ...
 //for (Long64_t jentry=0; jentry<nentries;jentry=jentry+10) {   //takes every 10th en
    ...
    // if(jentry < 10 || jentry%1000 == 0) std::cout << "analysisClass::Loop(): jentry = " << jentry << std::endl;   
     ...
     else
     {
       ...
       if(no_jets_ak4>=2)
	 {
	   if(fabs(jetEtaAK4->at(sortedJetIdx[0])) < getPreCutValue1("jetFidRegion") && jetCemfAK4->at(sortedJetIdx[0]) < 0.8 && idTAK4->at(sortedJetIdx[0])
	      && (jecFactors[sortedJetIdx[0]]/jetJecAK4->at(sortedJetIdx[0]))*jetPtAK4->at(sortedJetIdx[sortedJetIdx[0]]) > getPreCutValue1("pt0Cut"))
	     {
	       if(fabs(jetEtaAK4->at(sortedJetIdx[1])) < getPreCutValue1("jetFidRegion") && jetCemfAK4->at(sortedJetIdx[1]) < 0.8 && idTAK4->at(sortedJetIdx[1])
...
if(MJJWide>3558 && MJJWide<3704 &&  (triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second))) 
{cout.precision(25);
cout << " event OR " << evtNo << "run OR" << runNo << "lumi OR" << lumi << endl;



}

if (MJJWide >3558 & MJJWide<3704 && (triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second))) 
{cout.precision(25);
cout << " event " << evtNo << "run" << runNo << "lumi" << lumi << endl;

cout << "pT_jet1 =  " << widejets[0].Pt() << "    eta_jet1 = " << widejets[0].Eta() << "\tphi_jet1 = " << widejets[0].Phi() << "  chf_jet1 = " << jetChfAK4->at(sortedJetIdx[0]) << "\tcemf_jet1 = " << jetCemfAK4->at(sortedJetIdx[0])  << "  nhf_jet1 = " << jetNhfAK4->at(sortedJetIdx[0]) << " nemf_jet1 = " << jetNemfAK4->at(sortedJetIdx[0]) << "\tmuf_jet1 = " << jetMufAK4->at(sortedJetIdx[0]) << " phf_jet1 = " << jetMufAK4->at(sortedJetIdx[0]) << "  NM = " << neMultAK4->at(sortedJetIdx[0]) << "CM = " << chMultAK4->at(sortedJetIdx[0])<< "PM = " << phoMultAK4->at(sortedJetIdx[0]) << endl;

cout << "pT_jet2 =  " << widejets[1].Pt() << "   eta_jet2 = " << widejets[1].Eta() << "\tphi_jet2 = " << widejets[1].Phi() << " chf_jet2 = " << jetChfAK4->at(sortedJetIdx[1]) << "\tcemf_jet2 = " << jetCemfAK4->at(sortedJetIdx[1])  << " nhf_jet2 = " << jetNhfAK4->at(sortedJetIdx[1]) << " nemf_jet2 = " << jetNemfAK4->at(sortedJetIdx[1]) << "\tmuf_jet2 = " << jetMufAK4->at(sortedJetIdx[1]) <<  " phf_jet2 = " << jetPhfAK4->at(sortedJetIdx[1]) << " NM = " << neMultAK4->at(sortedJetIdx[1]) << " CM = " << chMultAK4->at(sortedJetIdx[1])<< " PM = " << phoMultAK4->at(sortedJetIdx[1]) << endl;

}

//EDW 
int diastasi=sortedJetIdx.size();
cout<< " diastasi " << diastasi <<  endl;
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass[1] -> Fill(MJJWide);

if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)&& triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass[2] -> Fill(MJJWide);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass[3] -> Fill(MJJWide);


if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second)&& triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass[4] -> Fill(MJJWide);

if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)&& triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass[5] -> Fill(MJJWide);
...
//or of all currently unprescaled triggers
...
&& triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second))  h_mjj_HLTpass[12] -> Fill(MJJWide);*/
...
&& triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second))  h_mjj_HLTpass[6] -> Fill(MJJWide);

if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second) &&! ( triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)
)) h_mjj_HLTpass[7] -> Fill(MJJWide);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second) &&! ( triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)
...
if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second) &&! ( triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)
...
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) && triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second) &&! ( triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) 
...
&& triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second))  h_mjj_HLTpass[11] -> Fill(MJJWide);
...
&& triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second))  h_mjj_HLTpass[13] -> Fill(MJJWide);
