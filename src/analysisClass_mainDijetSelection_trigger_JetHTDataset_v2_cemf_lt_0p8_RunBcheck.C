...
void analysisClass::Loop()
{
 ...
 char* HLTname[50]    = {"noTrig","PFHT1050","PFJet550","Mu50", "AK8PFJet500","CaloJet550","AllJet","PFHT1050_not_OR_from_others","PFJet550_not_OR_from_others","AK8PFJet500_not_OR_from_others","CaloJet550_not_OR_from_others","PFHT1050_OR_AK8PFJet500","PFHT1050_OR_PFJet550","PFHT1050_OR_CaloJet550"};
...
if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second)) h_mjj_HLTpass[4] -> Fill(MJJWide);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) &&!( triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)
...
if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) &&!( triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second)
...
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) &&!( triggerResult->at(triggerMap_.find("HLT_AK8PFJet500_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second)
