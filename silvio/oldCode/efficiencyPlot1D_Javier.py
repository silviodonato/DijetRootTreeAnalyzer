...
preselect = denTrigger + " && abs(deltaETAjj)<1.3 && abs(etaWJ_j1)<2.5 && abs(etaWJ_j2)<2.5 && pTWJ_j1>65 && pTWJ_j2>40 && PassJSON && passHLT_CaloJet40_CaloScouting_PFScouting && mjj>100 && run<=280385 && run>=277991"
