...
functions = [
("exp(pars[2]*x/pars[0]) * 1./pow(x/pars[0],pars[1])","DijetFisherNom3"),
("exp(pars[2]*x/pars[0]) * (- 1 + x/pars[0]*pars[3])/pow(x/pars[0],pars[1])","DijetFisherNom4"),
("exp(pars[2]*x/pars[0]) * (- 1 + x/pars[0]*pars[3] + pow(x/pars[0],3)*pars[4])/pow(x/pars[0],pars[1])","DijetFisherNom5"),
("exp(pars[2]*x/pars[0]) * (- 1 + x/pars[0]*pars[3] + pow(x/pars[0],3)*pars[4] + pow(x/pars[0],5)*pars[5])/pow(x/pars[0],pars[1])","DijetFisherNom6"),
("exp(pars[2]*x/pars[0]) * (- 1 + x/pars[0]*pars[3] + pow(x/pars[0],3)*pars[4] + pow(x/pars[0],5)*pars[5] + pow(x/pars[0],7)*pars[6])/pow(x/pars[0],pars[1])","DijetFisherNom7"),
("(- 1 + x/pars[0]*pars[2])/pow(x/pars[0],pars[1]) ","DijetFisherAlt3"),
("(- 1 + x/pars[0]*pars[2])/pow(x/pars[0],(pars[1] + pars[3]*log(x/pars[0]))) ","DijetFisherAlt4"),
("(- 1 + x/pars[0]*pars[2])/pow(x/pars[0],(pars[1] + pars[3]*log(x/pars[0]) + pars[4]*pow(log(x/pars[0]),2))) ","DijetFisherAlt5"),
("(- 1 + x/pars[0]*pars[2])/pow(x/pars[0],(pars[1] + pars[3]*log(x/pars[0]) + pars[4]*pow(log(x/pars[0]),2) + pars[5]*pow(log(x/pars[0]),3))) ","DijetFisherAlt6"),
("(- 1 + x/pars[0]*pars[2])/pow(x/pars[0],(pars[1] + pars[3]*log(x/pars[0]) + pars[4]*pow(log(x/pars[0]),2) + pars[5]*pow(log(x/pars[0]),3))) ","DijetFisherAlt7"),
#("exp(pars[2]*x/pars[0]) * (- 1 + x/pars[0]*pars[3]) /pow(x/pars[0],pars[1])","DijetTest"),
#("exp(pars[2]*x/pars[0]) * (- pars[4] + x/pars[0]*pars[3]) /pow(x/pars[0],pars[1])","DijetTest2"),
#("exp(pars[2]*x/pars[0]) * (0 + x/pars[0]*pars[3]) /pow(x/pars[0],pars[1])","DijetTest3"),
#("exp(pars[3]*x/pars[0])*(x/pars[0] - pars[2])/pow(x/pars[0],pars[1])","DijetTest3"),
#("exp(pars[3]*x/pars[0])*(pow(x/pars[0] - pars[2],pars[4]))/pow(x/pars[0],pars[1])","DijetTest2"),
    ]
