...
("TMath::Erf( x/pars[0] - pars[2] ) * exp( pars[3]*x/pars[0])/pow(x/pars[0],pars[1])","DijetFisherTestNom4"),
("TMath::Erf( pars[2] * x/pars[0] - pars[4] ) * exp( pars[3]*x/pars[0])/pow(x/pars[0],pars[1])","DijetFisherTestNom5"),
]
